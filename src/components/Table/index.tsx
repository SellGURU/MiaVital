...
interface EnhancedTableProps {
  title: string;
  numSelected: number;
  onRequestSort: (event: React.MouseEvent<unknown>, property: keyof CityData) => void;
...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof CityData) => (event: React.MouseEvent<unknown>) => {
...
export default function EnhancedTable(props:EnhancedTable) {
  ...
  const visibleRows =React.useMemo(
    () =>
      stableSort(rows, getComparator(order, orderBy as keyof CityData)).slice(
        page * rowsPerPage,
