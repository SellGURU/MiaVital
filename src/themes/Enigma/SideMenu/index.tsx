...
function Main() {
  ...
  return (
    <div
      className={clsx([
        "enigma py-5 md:py-0 sm:px-8 md:px-0",
    ...
    >
      ...
      <div className="flex overflow-hidden">
        ...
        <div
          className={clsx([
            "max-w-full md:max-w-none rounded-[30px] md:rounded-none px-4 md:px-[22px] min-w-0 min-h-screen bg-white flex-1 md:pt-20 pb-10 mt-5 md:mt-1 relative dark:bg-darkmode-700",
